// Package store is Framewright's persistence — deliberately a single
...
type diskData struct {
	...
	// ClientIdentifier is THIS Framewright install's own stable identity
...
// first call if none exists yet — see cmd/framewright/main.go, which
...
// (cmd/framewright/main.go) — only takes effect once, on a store that's
...
// none yet — cmd/framewright/main.go's support for the optional
